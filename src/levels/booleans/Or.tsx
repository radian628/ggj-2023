...
function testOr(andCode: ASTNode) {
  const exprs = [
...
export function Or(props: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="lc-example">OR FALSE FALSE = FALSE</div>
      <div className="lc-example">OR FALSE TRUE = TRUE</div>
      <div className="lc-example">OR TRUE FALSE = TRUE</div>
      <div className="lc-example">OR TRUE TRUE = TRUE</div>
      <div className="lc-example">
        OR = <CodeEditor val={code} setVal={setCode}></CodeEditor>
      </div>
    </section>
  );
}
